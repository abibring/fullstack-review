...
export default class LandingPage extends Component {
  ...
  render() {
    return (
      <Jumbotron style={{ backgroundImage: "url('https://www.google.com/url?sa=i&source=images&cd=&cad=rja&uact=8&ved=2ahUKEwjNo6eA55rfAhVHhuAKHTR2A8UQjRx6BAgBEAU&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F550635491916707639%2F&psig=AOvVaw2sH0veCc04jDVLnqxQM5aY&ust=1544721724750902')", height: 700 }}>
